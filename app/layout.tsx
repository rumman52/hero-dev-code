...
const siteUrl = 'https://example.com'; // TODO: replace with the production canonical URL before launch.
export const metadata: Metadata = { metadataBase:new URL(siteUrl), title:'Md Rumman Ali — Problem-Solver Tech Engineer', description:'Md Rumman Ali builds practical AI, digital-health, climate, and social-impact solutions from Bangladesh.', alternates:{canonical:'/'}, openGraph:{title:'Md Rumman Ali — Problem-Solver Tech Engineer',description:'Md Rumman Ali builds practical AI, digital-health, climate, and social-impact solutions from Bangladesh.',url:'/',siteName:'Md Rumman Ali / Solve.',type:'website'}, twitter:{card:'summary_large_image',title:'Md Rumman Ali — Problem-Solver Tech Engineer',description:'Md Rumman Ali builds practical AI, digital-health, climate, and social-impact solutions from Bangladesh.'}};
